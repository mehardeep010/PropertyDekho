...
-- ────────────────────────────────────────────────────────────
-- FIX 1: AGENT_INQUIRY is redundant — INQUIRY.Agent_ID already stores the relationship. Droped to avoid inconsistency.
-- ────────────────────────────────────────────────────────────
DROP TABLE IF EXISTS AGENT_INQUIRY;


-- ────────────────────────────────────────────────────────────
-- FIX 2: AMENITY.Amenity_Name must be UNIQUE (no duplicate "Gym")
-- ────────────────────────────────────────────────────────────
...
-- ────────────────────────────────────────────────────────────
-- FIX 3: PAYMENT — added Payment_Type to distinguish purpose
-- ────────────────────────────────────────────────────────────
ALTER TABLE PAYMENT
...
--   • Block insertion if an active (non-Terminated/Expired) lease already exists for this property with overlapping dates
-- ============================================================
DELIMITER $$
